...
if("FALSE" STREQUAL "TRUE")
  set(hector_trajectory_server_SOURCE_PREFIX /home/romain/LaDernierechance/src/hector_slam/hector_trajectory_server)
  set(hector_trajectory_server_DEVEL_PREFIX /home/romain/LaDernierechance/devel)
  ...
  set(hector_trajectory_server_INSTALL_PREFIX /home/romain/LaDernierechance/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/romain/LaDernierechance/install/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
