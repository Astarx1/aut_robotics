...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vrep_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/romain/catkin_ws/install/${idir}'.  Ask the maintainer 'Marc <marc@coppeliarobotics.com>' to fix it.")
    endif()
