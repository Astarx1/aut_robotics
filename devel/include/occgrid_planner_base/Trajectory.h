// Generated by gencpp from file occgrid_planner_base/Trajectory.msg
// DO NOT EDIT!
...
template <class ContainerAllocator>
struct IsFixedSize< ::occgrid_planner_base::Trajectory_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::occgrid_planner_base::Trajectory_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::occgrid_planner_base::Trajectory_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::occgrid_planner_base::Trajectory_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::occgrid_planner_base::Trajectory_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::occgrid_planner_base::Trajectory_<ContainerAllocator> const>
  : TrueType
  { };
