...
"""autogenerated by genpy from occgrid_planner/Trajectory.msg. Do not edit."""
import sys
...
float64 z"""
  __slots__ = ['header','Ts']
  _slot_types = ['std_msgs/Header','occgrid_planner/TrajectoryElement[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = occgrid_planner.msg.TrajectoryElement()
        _v9 = val1.header
        start = end
        end += 4
