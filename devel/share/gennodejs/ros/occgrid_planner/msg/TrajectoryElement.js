...
// (in-package occgrid_planner.msg)
...
class TrajectoryElement {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryElement(null);
  ...
  static datatype() {
    ...
    return 'occgrid_planner/TrajectoryElement';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryElement(null);
...
module.exports = TrajectoryElement;
